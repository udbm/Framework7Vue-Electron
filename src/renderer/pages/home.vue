<template>
  <f7-page class="page-home">
    <f7-navbar large largeTransparent :sliding="false">
      <f7-nav-left>
        <f7-link panel-open="left" link="/panel-left/" icon-ios="f7:menu" icon-aurora="f7:menu" icon-md="material:menu"></f7-link>
      </f7-nav-left>
    ...
    <f7-list class="searchbar-hide-on-search">
      <f7-list-item title="About Framework7" link="/about/">
        <f7-icon slot="media" md="f7:app_fill" color="gray"></f7-icon>

      </f7-list-item>
    </f7-list>

    <f7-block-title medium class="searchbar-found">Components{{ totalTvCount }}</f7-block-title>
    <f7-list class="components-list searchbar-found">
      <f7-list-item link="/electron/" title="Electron Features">
        <f7-icon slot="media" md="f7:gear" color="gray"></f7-icon>
      </f7-list-item>
    ...
    <f7-list class="searchbar-hide-on-search">
      <f7-list-item title="iOS Theme" external link="./index.html?theme=ios"><f7-icon slot="media" md="f7:logo_ios" color="gray"></f7-icon></f7-list-item>
      <f7-list-item title="Material (MD) Theme" external link="./index.html?theme=md"><f7-icon slot="media" md="f7:logo_android" color="gray"></f7-icon></f7-list-item>
      <f7-list-item title="Aurora Desktop Theme" external link="./index.html?theme=aurora"><f7-icon slot="media" md="f7:desktopcomputer" color="gray"></f7-icon></f7-list-item>
      <f7-list-item title="Color Themes" link="/color-themes/"></f7-list-item>
    </f7-list>

    <f7-block-title medium class="searchbar-hide-on-search">Page Loaders & Routers</f7-block-title>
    <f7-list class="searchbar-hide-on-search">
